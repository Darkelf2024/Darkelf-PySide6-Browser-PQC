...
class MLKEM1024Manager:
    """
    A manager for ML-KEM-1024 (Kyber1024) using OQS for KEM
    ...
    def generate_keys_and_encrypt(self) -> None:
        try:
            ...
            print("[*] ML-KEM-1024 keys generated successfully.")
...
class NetworkProtector:
    """
    Tor-link protector using ML-KEM-1024 for KEM + AES-GCM for payload.
...
class Darkelf(QMainWindow):
    def __init__(self):
        ...
        # --- Synchronous ML-KEM 1024 key manager ---
        self.kyber_manager = MLKEM1024Manager(sync=False)
        # Print confirmation in main thread
        print("MLKEM1024Manager created in Darkelf.")
    ...
    def start_tor(self):
        try:
            ...
            try:
                ...
                kem_ephemeral = oqs.KeyEncapsulation("ML-KEM-1024")
