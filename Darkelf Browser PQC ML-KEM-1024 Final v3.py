...
class Kyber1024Manager:
    """
    A manager for ML-KEM-1024 (Kyber1024) key generation, encryption, and decryption using AES-GCM.
    ...
    def generate_keys_and_encrypt(self):
        try:
            # Generate Kyber1024 keypair and keep the kem instance
    ...
    def decrypt_data(self):
        try:
            ...
            # Decapsulate the shared secret from the Kyber1024 ciphertext
...
class Darkelf(QMainWindow):
    def __init__(self):
        ...
        self.kyber_manager = Kyber1024Manager(sync=True)
