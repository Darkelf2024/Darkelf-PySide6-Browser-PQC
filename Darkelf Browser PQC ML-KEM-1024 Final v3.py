...
class Kyber1024Manager:
    """
    Production-ready manager for ML-KEM-1024 (Kyber1024) key generation, encryption,
    and decryption using AES-GCM and structured secure transport.
    """
    ...
    def generate_keys_and_encrypt(self) -> None:
        try:
            ...
            print("[*] Kyber1024 keys generated.")
            ...
            self.encrypted_data = base64.b64encode(json.dumps(blob).encode()).decode()
    ...
    def is_ready(self) -> bool:
        return self._encryption_done.is_set()
...
class Darkelf(QMainWindow):
    def __init__(self):
        ...
        self.kyber_manager = Kyber1024Manager(sync=False)
        # Print confirmation in main thread
        print("Kyber1024Manager created in Darkelf.")
