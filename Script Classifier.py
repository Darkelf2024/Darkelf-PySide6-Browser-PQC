...
# === Silence warnings for clean training ===
warnings.filterwarnings("ignore")

# === Feature Labels (ML/Ad/Threat Detection) ===
feature_names = [
    "length",
    "cookie_access",
    "localStorage_access",
...
# === Synthetic Sample Dataset (expandable with real telemetry) ===
X = np.array([
...
# 0 = Safe, 1 = Malicious, 2 = Ad Script
y = np.array([1, 0, 1, 0, 1, 0, 1, 0, 2, 0, 2, 0, 2, 0, 2])
